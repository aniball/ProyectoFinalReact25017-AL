...
const About = () => {
  return (
    <div className="max-w-5xl mx-auto p-6">
      <Card className="shadow-md rounded-xl p-8 bg-white dark:bg-gray-800 text-gray-800 dark:text-gray-100">
        <div className="flex flex-col items-center text-center">
          <img src={logo} alt="Athos Shop Logo" className="h-20 mb-6" />
          <h1 className="text-3xl font-bold text-blue-700 dark:text-blue-300 mb-2">Sobre Athos Shop</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-8">
          <div>
            <h2 className="text-xl font-semibold text-gray-800 dark:text-white mb-2">Nuestra misión</h2>
          ...
          <div>
            <h2 className="text-xl font-semibold text-gray-800 dark:text-white mb-2">¿Por qué elegirnos?</h2>
        ...
        <div className="mt-8 text-center">
          <p className="text-gray-500 dark:text-gray-400 text-sm">Gracias por elegirnos. ¡Felices compras!</p>
        </div>
      </Card>
    </div>
  );
